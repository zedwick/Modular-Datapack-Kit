...
#
# Sets game state to Setup_Lobby, and handles any other requirements.
#
...
scoreboard players operation game_state mdk_rounds_val = state_setup_lobby mdk_rounds_const
...
# Run functions tagged to run when state changes to setup_lobby...
function #mdk_rounds:event/game_state_changed/to_setup_lobby
