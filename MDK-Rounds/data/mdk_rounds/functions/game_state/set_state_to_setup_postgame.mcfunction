...
#
# Sets game state to Setup_PostGame, and handles any other requirements.
#
...
scoreboard players operation game_state mdk_rounds_val = state_setup_postgame mdk_rounds_const
...
# Run functions tagged to run when state changes to setup_postgame...
function #mdk_rounds:event/game_state_changed/to_setup_postgame
